...
public class ExercicesIntroTestingTest {
    ...
    public void testFindLast1(){
        final int result = ExercicesIntroTesting.findLast(new int []{0, 1, 2}, 2);
        assertEquals(result, 2);
    }

    @Test
    public void testLastZero1(){
        final int result = ExercicesIntroTesting.lastZero(new int []{3, 1, 0});
        assertEquals(result, 2);
    }
    ...
    public void testOddOrPos1(){
        final int result = ExercicesIntroTesting.oddOrPos(new int []{-3, -2, 1, 3, 4});
        assertEquals(result, 3);
    }
}
